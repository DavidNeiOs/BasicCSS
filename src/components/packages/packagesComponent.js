      ...
      <div className="packages-overview">
        ...
        <section className="packages-plan" id="plus">
          <Link to="/packages/plus" className="packages-plan__link">
            ...
            <h2 className="packages-plan__feature">The most popular choice of our customers.</h2>
        ...
        <section className="packages-plan" id="free">
          <Link to="/packages/free" className="packages-plan__link">
            ...
            <h2 className="packages-plan__feature">An extremely solid start into our hosting world.</h2>
            <p className="packages-plan__description">Get started immediately at zero cost!</p>
          </Link>
        </section>
        <div className="clearFix" />
        <section className="packages-plan packages-plan__highlighted" id="premium">
